...
try:
    ...
    print("BLENDYN::matplotlib.py: could not import dependencies. Plotting " \
...
class BLENDYN_OT_mplot_trajectory_object(bpy.types.Operator):
    """Plot trajectory graph of (3X3) matrix variable using matplotlib"""
    ...
    def execute(self, context):
        ...
        plt.suptitle("TRAJECTORY OF {0}".format(pvar.name))
